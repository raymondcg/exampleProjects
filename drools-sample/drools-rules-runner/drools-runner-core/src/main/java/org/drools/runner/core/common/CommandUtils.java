...
public class CommandUtils {
	...
	/**
	 * Creates query commands based on the {@link KieQuery} annotated fields in
	 * the Class parameter.
	 * 
	 */
	...
	/**
	 * Creates setGlobal commands based on the {@link KieGlobal} annotated
	...
	/**
	 * Builds a BatchExecutionCommand from the arguments, adding any
	 * setGlobalCommands from the {@link KieGlobal} annotated fields on the
	 * Request, inserts all facts from the Request, adds any queries configured
	 * via {@link KieQuery{ on the ResponseClazz, and starts the process
	 */
